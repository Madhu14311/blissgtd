...
function LoginContent({ navigation }) {
  ...
  // On web, cap the login card at 480px and center it
  const contentMaxWidth = isWeb ? Math.min(width, 480) : width;
  ...
  return (
    <SafeAreaView style={s.safeArea}>
      ...
      >
        ...
        <Animated.View style={[s.topGlow, { opacity: glowOpacity, width: width * 1.18 }]} />
        <Animated.View style={[s.bottomGlow, { opacity: glowOpacity, width: width * 1.25 }]} />
        ...
        >
          <ScrollView
            contentContainerStyle={[
              s.scroll,
              {
                ...
                // On web: center a capped-width column
                ...(isWeb && {
                  alignSelf: "center",
          ...
          >
            {/* HERO IMAGE CARD */}
            <View style={[s.heroCard, { height: Math.min(height * 0.22, 200) }]}>
              <ImageBackground
...
const s = StyleSheet.create({
  ...
  // BlurView replacement — gives glass-dark look on all platforms including web
  cardBlur: {
    backgroundColor: "rgba(8,28,28,0.78)",
  },
