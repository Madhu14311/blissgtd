    ...
    return (
      <View style={[vc.card, { borderColor: '#A5D6A7', backgroundColor: '#F0FFF4' }]}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={vc.sub}>Your admin account is fully verified by Super Admin.</Text>
        </View>
      </View>
    );
  }
    ...
    return (
      <View style={[vc.card, { borderColor: '#BFDBFE', backgroundColor: '#EFF6FF' }]}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={vc.sub}>Your documents are being reviewed by the Super Admin. Full access granted after approval.</Text>
        </View>
      </View>
    );
  }
  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        ...
        <Text style={vc.sub}>
          {isRejected
            ? 'Your documents were rejected. Tap to resubmit for Super Admin review.'
            : 'Tap here to upload society & ID documents for Super Admin approval.'}
        </Text>
      </View>
    ...
    <SafeAreaView style={s.root}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ paddingHorizontal: 16, marginBottom: 12 }}>
          <Text style={s.sectionTitle}>🪪 Account Verification</Text>
        ...
        <TouchableOpacity style={s.logoutBtn}
          onPress={() => Alert.alert('Logout', 'Log out?', [
